...
void main(){gl_Position=position;}`;
  ...
  // Listens on window so it works even with pointer-events: none on the canvas
  class PointerHandler {
    ...
    cleanup() { this.cleanupFns.forEach((fn) => fn()); }
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (pointersRef.current) pointersRef.current.cleanup();
    };
